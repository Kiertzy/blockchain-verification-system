...
const Admin = () => {
    ...
    const exportInstitutionsCSV = () => {
        if (filteredUsers.length === 0) {
            message.warning("No approved admins found.");
            return;
        }
        ...
        link.href = url;
        link.setAttribute("download", "approved_admins.csv");
        ...
        <div className="flex flex-col gap-y-4">
            ...
            <div className="rounded border border-gray-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900">
                <div className="border-b border-gray-200 p-4 dark:border-slate-700">
                    <p className="text-lg font-medium text-slate-900 dark:text-white">List of Admins</p>
                </div>
