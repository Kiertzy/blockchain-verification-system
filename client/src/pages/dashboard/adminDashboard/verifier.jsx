...
const Verifier = () => {
    ...
    const exportInstitutionsCSV = () => {
        if (filteredUsers.length === 0) {
            message.warning("No approved verifier found.");
            return;
        }

        const csvHeader = ["#", "First Name", "Middle Name", "Last Name", "Sex", "Email", "Role", "Status"];
        ...
        link.href = url;
        link.setAttribute("download", "approved_verifiers.csv");
    ...
    return (
        <div className="flex flex-col gap-y-4">
            <h1 className="title">Verifier</h1>
            ...
            <div className="rounded border border-gray-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900">
                <div className="border-b border-gray-200 p-4 dark:border-slate-700">
                    <p className="text-lg font-medium text-slate-900 dark:text-white">List of Verifier</p>
                </div>
                                            ...
                                            >
                                                ...
                                                <td className="flex gap-2 whitespace-nowrap border-b px-4 py-2 font-bold text-yellow-500 dark:border-slate-700">
                                                    <button
                                                        ...
                                                        onClick={() => navigate(`/admin/verifier/details/${user._id}`)}
                                                        disabled={updating}
                                                    >
                                                        View
                                                    </button>
